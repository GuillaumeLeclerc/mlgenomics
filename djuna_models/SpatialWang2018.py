...
class SpatialWang2018DataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        return DataLoader(self.train_dataset, batch_size=self.batch_size,pin_memory=True, shuffle=True, num_workers=0) # is train_dataloader sampling from the given train set a smaller set to train on in this iteration?
